...
function getDistanceAlpha( p1, p2 ) {
    return getDistanceNumeric( gridrefLetToNum(p1), gridrefLetToNum(p2) );
};

function getDistanceNumeric( p1, p2 ) {
    var dx = p1.east - p2.east;
    var dy = p1.north - p2.north;
    return Math.sqrt((dx*dx)+(dy*dy));
};

module.exports = { 
    latLonToGrid: 				LatLongToOSGrid,  
    gridToLatLon: 				OSGridToLatLong,
    getNumericGrid: 			gridrefLetToNum,
    getAlphaGrid: 				gridrefNumToLet,
    getDistanceNumeric: 	getDistanceNumeric,
    getDistanceAlpha: 		getDistanceAlpha
};
